...
/***/ "./src/js/components/cosomize.js":
/*!***************************************!*\
  !*** ./src/js/components/cosomize.js ***!
  \***************************************/
/***/ (() => {

const item = document.querySelector(".costomize__list");
const itemContent = document.querySelectorAll(".costomize__item");
const img = document.querySelectorAll(".costomize__img-content");
...
function hide() {
  ...
  itemContent.forEach(item => {
    item.classList.remove("costomize__item-active");
  });
}
...
function show() {
  ...
  itemContent[i].classList.add("costomize__item-active");
}
...
item.addEventListener("click", event => {
  ...
  if (target && target.classList.contains("costomize__item")) {
    itemContent.forEach((item, i) => {
      if (target == item) {
        hide();
        show(i);
      }
